...
output_file = SCRIPT_DIR / "nabirds.tar.gz"
output_dir = SCRIPT_DIR / "nabirds"
...
# Move all contents of nabirds/nabirds to nabirds
os.system(f"mv {output_dir}/nabirds/* {output_dir}/")
# Remove the now empty nabirds directory
os.rmdir(output_dir / "nabirds")
...
# Define paths
DATASET_DIR = SCRIPT_DIR / "nabirds"
...
# Move the dataset.yaml to the yolo_dataset directory
shutil.move(SCRIPT_DIR / 'dataset.yaml', OUTPUT_DIR)
